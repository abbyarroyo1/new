...
public class HumaneSocietyClient {
    ...
    public static void main(String[] args) {
        ...
        ReadExcelData.readDataForArrayLists(catList, dogList);
        //ReadExcelData.readDataForArrayLists(dogList);
        ...
        HumaneSociety HumaneSocietyInstance = new HumaneSociety(catList, dogList);
        ...
        Dogs searchDog = new Dogs(type, gender, color, age,0, build);
        Integer availableDogs = HumaneSocietyInstance.checkForDogs(searchDog);
        System.out.println("Number of available dogs: " + availableDogs);
    }
}
